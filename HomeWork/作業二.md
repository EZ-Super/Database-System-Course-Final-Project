...
CREATE TABLE reviews (
    review_id SERIAL PRIMARY KEY,  -- 即 BIGINT UNSIGNED NOT NULL AUTO_INCREMENT
...
CREATE TABLE login_logs (
    login_id SERIAL PRIMARY KEY,         -- 自己這張表的唯一主鍵
    user_id BIGINT UNSIGNED,             -- 要能對應 users.user_id
